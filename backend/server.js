...
app.use('/api/admin/agentes', authMiddleware, agentesRoutes);
app.use('/api/admin/inversionistas', authMiddleware, inversionistasRoutes);
app.use('/api/admin/comisiones', authMiddleware, comisionesRoutes);
