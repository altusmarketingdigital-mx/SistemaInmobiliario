...
export default function Admin() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 flex font-['Plus_Jakarta_Sans']">
      {/* Sidebar */}
      <aside className="w-64 bg-white border-r border-stone-200 text-stone-800 flex flex-col fixed h-full z-20 shadow-sm">
        <div className="p-6 border-b border-stone-100 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-stone-500 text-xs">Gestión Inmobiliaria</p>
          </div>
        </div>
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
          <button 
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all ${activeTab === 'proyectos' ? 'bg-[#b91c1c] text-white shadow-lg shadow-red-900/20' : 'text-stone-500 hover:bg-stone-50 hover:text-stone-900'}`}
          >
          ...
          <button 
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all ${activeTab === 'planos' ? 'bg-[#b91c1c] text-white shadow-lg shadow-red-900/20' : 'text-stone-500 hover:bg-stone-50 hover:text-stone-900'}`}
          >
          ...
          <button 
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all ${activeTab === 'lotes' ? 'bg-[#b91c1c] text-white shadow-lg shadow-red-900/20' : 'text-stone-500 hover:bg-stone-50 hover:text-stone-900'}`}
          >
          ...
          <button 
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all ${activeTab === 'compradores' ? 'bg-[#b91c1c] text-white shadow-lg shadow-red-900/20' : 'text-stone-500 hover:bg-stone-50 hover:text-stone-900'}`}
          >
          ...
          <button 
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all ${activeTab === 'propietarios' ? 'bg-[#b91c1c] text-white shadow-lg shadow-red-900/20' : 'text-stone-500 hover:bg-stone-50 hover:text-stone-900'}`}
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
            Propietarios
          </button>
          ...
          <button 
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all ${activeTab === 'operaciones' ? 'bg-[#b91c1c] text-white shadow-lg shadow-red-900/20' : 'text-stone-500 hover:bg-stone-50 hover:text-stone-900'}`}
          >
          ...
          <button 
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all ${activeTab === 'agentes' ? 'bg-[#b91c1c] text-white shadow-lg shadow-red-900/20' : 'text-stone-500 hover:bg-stone-50 hover:text-stone-900'}`}
          >
          ...
          <button 
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all ${activeTab === 'inversionistas' ? 'bg-[#b91c1c] text-white shadow-lg shadow-red-900/20' : 'text-stone-500 hover:bg-stone-50 hover:text-stone-900'}`}
          >
          ...
          <button 
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all ${activeTab === 'comisiones' ? 'bg-[#b91c1c] text-white shadow-lg shadow-red-900/20' : 'text-stone-500 hover:bg-stone-50 hover:text-stone-900'}`}
          >
          ...
          <div className="pt-4 mt-4 border-t border-stone-100">
            ...
            <button 
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all ${activeTab === 'bancos' ? 'bg-[#b91c1c] text-white shadow-lg shadow-red-900/20' : 'text-stone-500 hover:bg-stone-50 hover:text-stone-900'}`}
            >
            ...
            <button 
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all ${activeTab === 'transacciones' ? 'bg-[#b91c1c] text-white shadow-lg shadow-red-900/20' : 'text-stone-500 hover:bg-stone-50 hover:text-stone-900'}`}
            >
            ...
            <button 
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all ${activeTab === 'cobranza' ? 'bg-[#b91c1c] text-white shadow-lg shadow-red-900/20' : 'text-stone-500 hover:bg-stone-50 hover:text-stone-900'}`}
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
              Cobranza
            </button>
          ...
          <div className="pt-4 mt-4 border-t border-stone-100">
            ...
            <button 
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all ${activeTab === 'empleados' ? 'bg-[#b91c1c] text-white shadow-lg shadow-red-900/20' : 'text-stone-500 hover:bg-stone-50 hover:text-stone-900'}`}
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
              Empleados Base
            </button>
            ...
            <button 
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all ${activeTab === 'nomina' ? 'bg-[#b91c1c] text-white shadow-lg shadow-red-900/20' : 'text-stone-500 hover:bg-stone-50 hover:text-stone-900'}`}
            >
            ...
            <button 
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all ${activeTab === 'configuracion' ? 'bg-[#b91c1c] text-white shadow-lg shadow-red-900/20' : 'text-stone-500 hover:bg-stone-50 hover:text-stone-900'}`}
            >
        ...
        <div className="p-4 border-t border-stone-100">
          <button onClick={handleLogout} className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl text-sm font-semibold text-stone-500 hover:bg-stone-50 hover:text-red-600 transition-all">
